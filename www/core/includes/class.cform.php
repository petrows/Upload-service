<?php
/*----------------------------------------------------------------------------+
|    cForm class : Forms generator                                            |
|        Version : 1.0                                                        |
+-----------------------------------------------------------------------------+
|     Written by : Kerd; mailto:kerdster@gmail.com                            |
|  Modiffed Date : 25 Jan 2008                                                |
+----------------------------------------------------------------------------*/
...
<td>
	...
	<td width="150" align="center">
		...
		{
			$out .= '<td class="'.$this->class_input_ar.'" colspan="2" align="center">';
