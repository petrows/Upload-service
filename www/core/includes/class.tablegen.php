...
class tablegen
{
	var $cols 			= 1;				# Cols number (width)
	var $sp				= 1;				# CellSpacing option
	var $pad			= 3;				# CellPadding option
	var $width			= '100%';			# Table width
	var $border			= 0;				# Border
	var $table_style	= false;			# Table 'style' tag
	var $class_bg 		= 'tablegen_bg';	# Class for background
	var $class_table 	= 'tablegen_table';	# Class for table at all
	var $class_row_1	= 'tablegen_row1';	# Row class 1
	var $class_row_2	= 'tablegen_row2';	# Row class 1
	var $class_row_th	= 'tablegen_th';	# Row class th
	var $class_row_sep	= 'tablegen_sep';	# Row class separator
	var $td_def_align	= 'center';			# Default align in TD
	var $td_def_valign	= 'middle';			# Default valign in TD
	
	var $bg 			= true;				# Has border/background DIV tag?

	var $th_top			= true;				# Add titles to Top
	var $th_bottom		= true;				# Add titles to Bottom

	var $noutems_auto	= true;				# Add 'No items to show' auto, when no items added
	
	# Internal
	var $table_data = array ();
	var $table_th_data = array ();
	var $tabe_tr_params = array ();
