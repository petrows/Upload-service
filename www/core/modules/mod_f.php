...
class mod_f extends module_template
{
	function display ()
	{
		...
		{
			$f_link = URL.'/download/'.$u_data['code'].'/'.$f_data[$x]['upn'].'/'.$f_data[$x]['dh'].'/'.htmlspecialchars($f_data[$x]['file_name']);
			$f_flink = URL.'/download/force/'.$u_data['code'].'/'.$f_data[$x]['upn'].'/'.$f_data[$x]['dh'].'/'.htmlspecialchars($f_data[$x]['file_name']);
